...
class ProxyPassPath extends \Nethgui\Controller\TableController
{
...
*/
    public function initialize()
    {
        ...
        $this
            ...
            ->setColumns($columns)
            ->addTableAction(new \NethServer\Module\ProxyPass\ProxyPassPath\Modify('create'))
            ->addTableAction(new \Nethgui\Controller\Table\Help('Help'))
            ->addRowAction(new \NethServer\Module\ProxyPass\ProxyPassPath\Modify('update'))
            ->addRowAction(new \NethServer\Module\ProxyPass\ProxyPassPath\Modify('delete'))
        ;
